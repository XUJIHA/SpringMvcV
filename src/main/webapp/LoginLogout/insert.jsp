...
<body>
	...
	<div class="offcanvas-menu-wrapper">
		...
		<div class="header-configure-area">
			...
			<a href="<c:url value='/loginlogout/controller/searchAllServlet' />" class="bk-btn">Costmer Data</a>
		</div>
		...
		<div class="menu-item">
			<div class="container">
				<div class="row">
					<div class="col-lg-2">
						<div class="logo">
							<a href="./alreadyindex.jsp"> <img src="../img/logo.png" alt="">
							</a>
						</div>
					</div>
					<div class="col-lg-10">
	...
	<div class="table-wrapper">
		<form action='<c:url value="/insertServlet" />'
			...
			<p align="center">
				...
				<p align="center">
					請輸入您的密碼：<input type="password" name="USER_PASSWORD" id="textfield1" required/>
				</p>
				<p align="center">
					請輸入您的身分證字號：<input type="text" name="USER_IDENTITY" id="textfield2" required/>
				</p>
				<p align="center">
					請輸入您的E-mail：<input type="email" name="USER_EMAIL" id="textfield3" required/>
				</p>
				<p align="center">
					請輸入您的電話號碼：<input type="tel" name="USER_PHONE" id="textfield4" required/>
				</p>
				<p align="center">
					請輸入您的生日：<input type="date" name="USER_BIRTHDAY" id="textfield5" required/>
				</p>
				<p align="center">
					請輸入您的註冊日期：<input type="date" name="USER_REGISTRATION" id="textfield6" required/>
				</p>
			<div align="center">
		...
		<form action='<c:url value="alreadyindex.jsp" />' method='post'>
		<div align="center">
