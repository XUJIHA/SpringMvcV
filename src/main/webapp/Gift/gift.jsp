			...
			<div class="row">
				<div class="col-lg-12">
					<div class="breadcrumb-text">
						<h2>伴手禮介紹</h2>
						<div class="bt-option">
							<a href="<c:url value='/giftMaintain/DisplayAll' />">顯示全部伴手禮</a>
							<a href="<c:url value='/giftMaintain/DisplayPageProducts' />">管理伴手禮</a> 
<!-- 							_03_listBooks.controller.DisplayPageProducts.java --> 
							<a href="<c:url value='/giftMaintain/SouPreInsertServlet.do' />">新增伴手禮</a>
...
<%-- 				<c:forEach var="bean" items="${beans}"> --%>
					<div class="col-lg-4 col-md-6">
						<div class="room-item">
<%-- 						<img src="<c:url value='/ShowImgServlet?roomId=${bean.roomId}' />" alt=""> --%>
							<img src="<c:url value='/_00_init/getSouImage?id=${bean.souvenir_id}'  />" width="100" height="200" alt="">
							<div class="ri-text">
								<h4>${bean.souvenir_name}</h4>
								<h3>
									$${bean.souvenir_price}<span>/價錢</span>
								</h3>
								<table>
									<tbody>
										<tr>
											<td class="r-o">數量:</td>
 											<td>${bean.souvenir_num}</td> 
 										</tr> 
									</tbody>
								</table>
								<a href="<c:url value='PreDisDetail?id=${bean.souvenir_id}' />" class="primary-btn" name="id">More Details</a>
							</div>
						</div>
					</div>
				</c:forEach>
