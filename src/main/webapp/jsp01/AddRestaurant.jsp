...
<body>
	...
	<header class="header-section">
		...
		<form action="<c:url value='/AddRestaurantServlet'/>" method="post">
			<table align="center">
				<tr>
					<td align="center">新增餐廳資料</td>
				</tr>
<!-- 				<tr> -->
<!-- 					<td>編號<input type="number" -->
<!-- 						onkeyup="value=value.replace(/[^\d]/g,'') " name="restaurantid" -->
<%-- 						min="1"> <span style="color: red"><b>${nullError} --%>
...
<!-- 				</tr> -->
				...
				<tr>
					<td>價錢<input type="text"
						onkeyup="value=value.replace(/[^\d]/g,'') " name="restaurantprice">
				...
				<tr>
					<td>座位數<input type="text"
						onkeyup="value=value.replace(/[^\d]/g,'') " name="restaurantseat">
						<span style="color: red"><b>${nullError8}</b></span></td>
				</tr>
