...
<body>
	...
	<form action="<c:url value='/SearchArrange'/>" method="post" name="1"
		align="center">
	...
	<form action="<c:url value='/SearchArrangenameServlet'/>" method="post">
		<table align="center">
			<tr>
				<td align="Right">用訂位者姓名查詢訂單資料:</td>
				<td align="Left"><input type="text" name="arrangename"><span
					style="color: red"><b>${nullError}</b></span></td>
			</tr>
			<tr>
	...
	<form action="<c:url value='/SearchArrangephoneServlet'/>" method="post">
		<table align="center">
			<tr>
				<td align="Right">用訂位者電話查詢訂單資料:</td>
				<td align="Left"><input type="text" name="arrangephone"><span
	...
	<form action="<c:url value='/SearchArrangeResidServlet'/>" method="post">
		<table align="center">
			<tr>
				<td align="Right">用餐廳ID查詢訂單資料:</td>
				<td align="Left"><input type="number" min="1"
					name="restaurantid"><span style="color: red"><b>${nullError3}</b></span></td>
			</tr>
			<tr>
				<td colspan="2" align="center"><input type="submit" value="提交"></td>
			</tr>
