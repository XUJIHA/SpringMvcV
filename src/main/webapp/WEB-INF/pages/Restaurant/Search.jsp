...
<body>
	...
	<!-- 我的內容 -->
	<form action="SearchRestaurantServerlet" method="post"
		align="center">
	...
	<form action="SearchRestaurantServletbyid"
		method="post">
		<table align="center">
			<tr>
	...
	<form action="SearchRestype" method="post">
		<table align="center">
			<tr>
	...
	<form action="SearchRestaurantServletbyname"
		method="post">
		<table align="center">
			<tr>
	...
	<form action="SearchRestaurantServletbyaddress"
		method="post">
		<table align="center">
			<tr>
