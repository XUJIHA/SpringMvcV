...
<body>
	...
	<ul >
		<li><button style="margin: 10px 10px" type="submit" name="id" value=1>餐廳新增</button></li>
		<br>
		<li><button style="margin: 10px 10px" type="submit" name="id" value=2>餐廳刪除</button></li>
		<br>
		<li><button style="margin: 10px 10px" type="submit" name="id" value=3>餐廳修改</button></li>
		<br>
		<li><button style="margin: 10px 10px" type="submit" name="id" value=4>餐廳查詢</button></li>
...
<%-- 		<li><a href="<c:url value='/ControlServlet?id=4' />">餐廳查詢</a></li> --%>
	...
	<ul >
		<li><button style="margin: 10px 10px"type="submit" name="id" value=5>訂單新增</button></li>
		<br>
		<li><button style="margin: 10px 10px" type="submit" name="id" value=6>訂單刪除</button></li>
		<br>
		<li><button style="margin: 10px 10px" type="submit" name="id" value=7>訂單修改</button></li>
		<br>
		<li><button style="margin: 10px 10px" type="submit" name="id" value=8>訂單查詢</button></li>
