...
<!-- 				<li><a href="./contact.html">Contact</a></li> -->
	...
	<form name="login" action="<c:url value="account.controller" />" method="Post">
		
		<br>
		<div style="text-align: center">
			<label for="USER_EMAIL">E-mail :</label>
			<input type="email" id="USER_EMAIL" name="USER_EMAIL" placeholder="請輸入EMAIL"><br> 
		</div><br>
		<div style="text-align: center">	
			<label for="USER_PASSWORD">密碼:</label>
			<input type="password" id="USER_PASSWORD" name="USER_PASSWORD" placeholder="請輸入密碼"><br>
		</div><br>
		<div style="text-align: center">
			驗證碼：<input type="text" name="code" size=10 placeholder="請輸入驗證碼">
			<%--點選圖片可進行驗證碼重新整理--%>
			<img name="imgValidate"
				src="<%=request.getContextPath()%>/confirm.controller"
				onclick="refresh()">
		</div><br>
		<div style="text-align: center">
