				...
				<div class="col-lg-10 offset-lg-1">
					<div class="blog-details-text">
						...
						<div class="leave-comment">
							...
							<br>
							<form action="insertorder" method="POST" class="comment-form">
								<div class="row">
									<div class="col-lg-6">
									...
									<div class="col-lg-6">
										電話:<input type="number" name="userphone"
											value="${orderdetailsbean.userphone}">
									</div>
									<div class="col-lg-6">
										統一編號:<input type="number" name="company"
											value="${orderdetailsbean.company}">
									</div>
									<div class="col-lg-6">
										入住日期:<input type="text" name="checkindate"
											value="${checkindate}">
									</div>
									<div class="col-lg-6">
										退房日期:<input type="text" name="checkoutdate"
											value="${checkoutdate}">
									</div>
									<div class="col-lg-6">
									...
									<div class="col-lg-12 text-center">
										<button type="submit" class="site-btn">再次確認</button>
									</div>
									<br> <br>
								</div>
							</form>
