			...
			<div class="row">
				<div class="col-lg-12">
					<div class="breadcrumb-text">
						<h2>訂單管理</h2>
						<div class="bt-option">
							<a href="searchorder">訂單管理&nbsp;</a><span>修改訂單</span>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-10 offset-lg-1">
					<div class="blog-details-text">
						<div class="leave-comment">
							...
							<br>
							<form action="updateorder" method="POST" class="comment-form">
								<div class="row">
									...
									<div class="col-lg-6">
										房型:<input type="text" name="roomname" id="roomname"
											value="${orderbean.roomname}">

									</div>
									<div class="col-lg-6">
										金額:<input type="text" name="roomprice" id="roomprice"
									...
									<div class="col-lg-6">
										信箱:<input type="text" name="useremail" id="useremail"
											value="${orderdetailsbean.useremail}">
									</div>
									<div class="col-lg-6">
										電話:<input type="text" name="userphone" id="userphone"
											value="${orderdetailsbean.userphone}">
									</div>
									<div class="col-lg-6">
										統一編號:<input type="text" name="company" id="company"
											value="${orderdetailsbean.company}">
									</div>
									<div class="col-lg-6">
										大人:<input type="number" name="adults" id="adults"
											value="${orderdetailsbean.adults}">
									</div>
									<div class="col-lg-6">
										小孩:<input type="number" name="children" id="children"
											value="${orderdetailsbean.children}">
									</div>
									<div class="col-lg-12 ">
										備註事項:
										<textarea name="notes" id="notes">${orderdetailsbean.notes}</textarea>
									</div>
									<div class="col-lg-12 text-center">
										<button style="margin: 20px 20px" type="button" class="update"
            ...
            Swal.fire({
              ...
              cancelButtonText:'取消'
                ...
                if (result.isConfirmed) {
                    $.ajax({
                      url:'/Team3/updateorder',
                      method:"post",
                      dataType:"text",
                      data: {"orderid":orderid,"roomname":roomname,"roomprice":roomprice,"checkindate":checkindate,"checkoutdate":checkoutdate,
                    	  "username":username,"useremail":useremail,"userphone":userphone,"company":company,"adults":adults,"children":children,"notes":notes},
                    })
                    	.done(function () {
                    		$(location).attr('href', 'updatesuccess');
                        	console.log("update")
             			})//done
             			.fail(function(error) {
             			    console.log(error)
