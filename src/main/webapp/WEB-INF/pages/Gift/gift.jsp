				...
				<div class="col-lg-12">
					<div class="breadcrumb-text">
						...
						<div class="bt-option">
							...
							<a href="<c:url value='maintainGift.controller' />">管理伴手禮</a> 
...
<%-- 						<img src="<c:url value='/ShowImgServlet?roomId=${bean.roomId}' />" alt=""> --%>
							<img src="<c:url value='/getSouImage/${bean.souvenir_id}'  />" width="100" height="200" alt="">
							<div class="ri-text">
								...
								<a href="<c:url value='/giftDetail.controller/${bean.souvenir_id}' />" class="primary-btn" name="id">More Details</a>
							</div>
						</div>
					</div>
				</c:forEach>
