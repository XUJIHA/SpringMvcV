				...
				<div class="col-lg-12">
					<div class="breadcrumb-text">
						...
						<div class="bt-option">
							...
							<hr>
							<form action="<c:url value='/SearchServlet' />" method="get">
					...
					<input type="checkbox" id="cbStatus" name="cbStatus" value="1" <c:if test="${cbstatus==1}"><c:out value="checked" /></c:if>>&nbsp;搜尋空房　　
