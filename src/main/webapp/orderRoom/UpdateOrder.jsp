				...
				<div class="col-lg-10 offset-lg-1">
					<div class="blog-details-text">
						<div class="leave-comment">
							...
							<br>
							<form action="<c:url value='./orderRoom/UpdateOrderServlet'/>"method="POST"
								class="comment-form">
								<div class="row">
									...
									<div class="col-lg-6">
										房型:<input type="text" name="roomname"
											value="${orderbean.roomname}">

									</div>
									<div class="col-lg-6">
										金額:<input type="text" name="roomprice"
											value="${orderbean.roomprice}">

									</div>
									<div class="col-lg-6">
										入住日期:<input type="date" name="checkindate"
											value="${orderbean.checkindate}">
									</div>
									<div class="col-lg-6">
										退房日期:<input type="date" name="checkoutdate"
									...
									<div class="col-lg-6">
										信箱:<input type="text" name="useremail"
											value="${orderdetailsbean.useremail}">
									</div>
									<div class="col-lg-6">
										電話:<input type="text" name="userphone"
											value="${orderdetailsbean.userphone}">
									</div>
									<div class="col-lg-6">
										統一編號:<input type="text" name="company"
											value="${orderdetailsbean.company}">
									</div>
									<div class="col-lg-6">
										大人:<input type="number" name="adults"
											value="${orderdetailsbean.adults}">
									</div>
									<div class="col-lg-6">
										小孩:<input type="number" name="children"
											value="${orderdetailsbean.children}">
									</div>
									<div class="col-lg-12 ">
										備註事項:
										<textarea name="notes">${orderdetailsbean.notes}</textarea>
									</div>
									<div class="col-lg-12 text-center">
										<button style="margin: 20px 20px" type="submit"
											class="site-btn">修改</button>
									</div>
								</div>
							</form>
							<br> <br>
