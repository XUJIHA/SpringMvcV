...
public interface RoomTypeDao {
	...
	int insertRoomType(String roomId, String name, int status, int capacity, int bed, double size,
			int price, Blob img, String description, String equipment);
	
	int updateStatusById(String id, int status);

	int updateNameById(String id, String name);
	
	int updateFormById(String roomId, String name, int status, int capacity, int bed, double size,
			int price, Blob img, String description, String equipment);
