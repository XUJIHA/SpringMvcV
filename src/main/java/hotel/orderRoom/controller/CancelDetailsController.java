...
@Controller
public class CancelDetailsController {

	@Autowired
	private OrderService oService;

	@RequestMapping(path = "/canceldetails", method = RequestMethod.GET)
	public String processAction1(@RequestParam("orderid") String orderidStr, Model m) {
		...
		return "orderRoom/orderCancel";
	}

	@RequestMapping(path = "/canceldetails", method = RequestMethod.POST)
