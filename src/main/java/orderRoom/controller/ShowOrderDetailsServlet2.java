...
@WebServlet("/orderRoom/ShowOrderDetailsServlet2")
public class ShowOrderDetailsServlet2 extends HttpServlet {
...
//		OrderDao orderDao = new OrderDao(session);
		...
		RequestDispatcher rd = request.getRequestDispatcher("/orderRoom/CancelOrder.jsp");
